...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "群山如海，深壑如剑。阴云翻涌之上，一束光穿透天幕，直落谷底。那光仿佛天地间的一道信使，照亮了千年的寂静，也照亮了人心中那份隐秘的震撼与敬畏。",
      image: "/image/河北/2.jpg",
    },
    {
      title:
        "清风楼伫立于城畔古木间，檐角微翘，流云穿梭。夕阳铺洒，飞鸟掠过楼檐，一声钟鸣唤醒古韵。它不喧不扰，只将岁月的气息缓缓散入风中，成了城市的心脉与安宁。",
      image: "/image/河北/3.jpg",
    },
    {
      title:
        "黎明的海面映着微光，浪花轻抚沙岸，远处的天边燃起一线橙红。这里是秦皇岛——海风带着盐的气息，吹拂过岁月的宁静。城市与海相依，浪潮起落间，藏着北方滨海的温柔与辽阔。",
      image: "/image/河北/4.jpg",
    },
    {
      title:
        "当晨曦跃上坝上的山岗，云雾铺展如海，风车缓转。张家口的高原光影深远，草甸起伏间藏着北疆的静谧与豪情。阳光照透云层，天地交融，仿佛大地在深呼吸。",
      image: "/image/河北/10.jpg",
    },
  ];
