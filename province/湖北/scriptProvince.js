...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title: "从黄鹤楼到长江桥——江城的目光，跨越千年。",
      image: "/image/湖北/武汉.png",
    },
    {
      title: "钢筋筑梦，江水为脉。",
      image: "/image/湖北/1.png",
    },
    {
      title: "桥下千江月，桥上万家灯。",
      image: "/image/湖北/2.png",
    },
    {
      title: "长江分城，桥却连心",
      image: "/image/湖北/武汉大桥.png",
    },
  ];
  ...
  function animateIndicators(index) {
    ...
    // console.log("indicators 类型:", typeof indicators);
    // console.log("indicators 实际值:", indicators);
    // console.log("是否为数组:", Array.isArray(indicators));
