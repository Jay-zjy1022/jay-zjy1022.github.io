...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "汴梁梦回，宋韵再现。画卷中的繁华在这里重生，亭台楼榭，水巷回廊，风拂柳丝，人声鼎沸，一步一景皆是宋风古韵的延续。",
      image: "/image/河南/清明上河图.png",
    },
    {
      title:
        "殷商遗响，青铜之魂。现代建筑的极简线条，与千年前的甲骨文相对凝视。那是一段文明的回声，从殷墟土壤中传来，深沉而肃穆。",
      image: "/image/河南/殷墟12.png",
    },
    {
      title:
        "云烟缭绕，金顶辉映，山川如画。老君山以其道教圣境与奇峰飞阁闻名，朝霞映金殿，犹如仙境人间。那一抹晨光，照见的是千年道韵与山川静意。",
      image: "/image/河南/老君山13.png",
    },
    {
      title:
        "千佛俯瞰，灯火如昼，石壁上镌刻着北魏的虔诚与盛唐的气象。佛光映水，石影生辉，这里是中原艺术与信仰的永恒丰碑。",
      image: "/image/河南/龙门石窟1.png",
    },
  ];
