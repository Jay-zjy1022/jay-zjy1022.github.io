...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title: "一岭生烟，一壑藏雾；日照金顶，风过松语。",
      image: "/image/安徽/黄山.png",
    },
    {
      title: "云绕奇峰，山藏远梦；天光破晓，影动心中。",
      image: "/image/安徽/黄山1.png",
    },
    {
      title:
        "白墙入镜，红灯照水；一村一梦，一景一诗。水波不语，岁月无声。古意在风里，也在灯下。",
      image: "/image/安徽/皖南古村落2.png",
    },
    {
      title:
        "灯影摇红，墙影如墨；旧巷深深，梦回徽州。光落青砖，影藏旧梦；一城灯火，一脉温柔。",
      image: "/image/安徽/皖南古村落3.png",
    },
  ];
