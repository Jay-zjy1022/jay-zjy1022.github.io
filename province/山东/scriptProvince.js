...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "旭日初升，金光照耀云海之巅。泰山层峦叠嶂，古松苍劲，道路蜿蜒。自秦汉以来，历代帝王在此封禅祭天，山中碑刻林立，仿佛刻录着中华文明的根脉。",
      image: "/image/山东/4.jpg",
    },
    {
      title:
        "光岳楼高耸于古运河畔，夕阳洒落，砖瓦映金。古街巷纵横，石桥静卧，悠悠古韵与现代城市的烟火交织成一幅流动的画卷。",
      image: "/image/山东/5.jpg",
    },
    {
      title:
        "每至深秋，红叶谷层林尽染，山风吹拂间，满谷如霞。湖光映影，石径蜿蜒，步入其中仿若走进一幅流动的秋画。这里，是济南最浓烈的季节色彩。",
      image: "/image/山东/9.jpg",
    },
    {
      title:
        "崂山雄踞于青岛之东，海气蒸腾，云烟常绕。山石奇峭，松风萧然，道观散落山腰之间。自古便有“海上第一名山”之称。于此登临，既可见山之险峻，又可听海之浩荡，天地相接，人心自清。",
      image: "/image/山东/10.jpg",
    },
  ];
