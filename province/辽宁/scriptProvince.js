...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "木色的码头伸向蔚蓝，游艇轻晃在晨光里，远山含雾，欧式穹顶闪着微光。大连，总带着浪漫的咸味。",
      image: "/image/辽宁/1.jpg",
    },
    {
      title:
        "红得惊心的滩涂铺展到天边，碱蓬草在风中摇曳，水鸟掠过水脊，带走辽河口的最后一抹霞光。",
      image: "/image/辽宁/2.jpg",
    },
    {
      title:
        "夜色倾泻，大桥宛若银链横贯海面，车流的光轨流淌不息。海风轻拂，浪涛低吟，大连在夜里最温柔。",
      image: "/image/辽宁/4.jpg",
    },
    {
      title: "辽宁尾矿",
      image: "/image/辽宁/7.jpg",
    },
    {
      title:
        "浑河如镜，城市的灯光流淌在水面。风吹过桥梁，带着初冬的凉意，也带来生活的温度。",
      image: "/image/辽宁/8.jpg",
    },
  ];
