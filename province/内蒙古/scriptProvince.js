...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "这座火山宛如地球的瞳孔，被时间雕琢成深邃的圆环。炽红与焦黑交织，仿佛一场被凝固的烈焰。风吹过，带着火山灰的味道，提醒人们：大地的心脏，仍在缓缓跳动。",
      image: "/image/内蒙古/5.jpg",
    },
    {
      title:
        "黄昏的光洒在山林之巅，天空燃起深紫与金红的交响。树林间传来微弱的虫鸣，空气中弥漫着松香。夜的帷幕缓缓降临，而此刻的山峦，正被余晖温柔地拥抱。",
      image: "/image/内蒙古/8.jpg",
    },
    {
      title:
        "河水清澈，倒映着金黄的树影。微风拂过，叶片纷纷坠落，如碎金飘洒。几位旅人站在河畔，静静地望着远山。此刻，时间仿佛停驻，只有秋色在流动。",
      image: "/image/内蒙古/9.jpg",
    },
    {
      title:
        "草原在阳光下铺展开无边的绿，牛羊成群，点缀其间。风吹草低，牧歌悠悠，天与地融为一色。这里没有喧嚣，只有自由的呼吸与自然的节奏，诉说着生命最原始的纯粹。",
      image: "/image/内蒙古/10.jpg",
    },
  ];
