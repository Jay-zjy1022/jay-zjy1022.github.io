...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "沱江之畔，吊脚楼依水而建，桥楼相连，流光倒影交织出湘西的千年梦。夜色温柔，古镇的鼓声与水波一同荡漾。",
      image: "/image/湖南/凤凰古镇1.png",
    },
    {
      title:
        "千年古镇依山临水，瀑布穿城而落，飞珠溅玉。灯火阑珊处，鼓声回荡于青石巷间，诉说土家旧梦。",
      image: "/image/湖南/芙蓉镇1.png",
    },
    {
      title:
        "岩岭如削，水色如镜，丹霞地貌在阳光下层叠生辉。云光掠影间，天地如一幅泼墨山水画",
      image: "/image/湖南/高椅岭1.png",
    },
    {
      title:
        "朝阳照云涛，山峰浮若岛。衡山的清晨，云雾翻涌，似仙境初开，天地一色，心境俱寂。",
      image: "/image/湖南/衡山云海.png",
    },
  ];
