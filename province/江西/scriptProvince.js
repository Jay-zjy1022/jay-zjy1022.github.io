...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "层峦间的风声轻柔，似在诉说千年的禅意。山与天交融，天地一色，只余静思。",
      image: "/image/江西/庐山1.png",
    },
    {
      title:
        "溪流顺着岩石滑落，水珠飞溅成银线。古木森然，石径幽深。每一步，都像踏入一幅水墨，淡而悠长。",
      image: "/image/江西/庐山2.png",
    },
    {
      title: "庐山的静，是一种有声的沉默。",
      image: "/image/江西/庐山3.png",
    },
    {
      title:
        "湖面平展如镜，微波荡漾着霞光。成群白鹤掠空而起，翅影如诗。水天无界，天地相接的那一线，是自由的边缘。",
      image: "/image/江西/鄱阳湖.png",
    },
    {
      title: "晨雾未散，芦苇摇曳。时间在湖面上缓缓流淌。",
      image: "/image/江西/鄱阳湖1.png",
    },
    {
      title:
        "奇峰突兀，仿佛古老的神灵伫立云端。阳光穿破雾海，照在峭壁松影之上。那是一种神性的宁静，美得不可亵渎。",
      image: "/image/江西/三清山.png",
    },
    {
      title:
        "石峰高耸如削，云海翻涌如梦。人在其中，如同行走在天与地之间，步步皆虚，念念皆真。",
      image: "/image/江西/三清山1.png",
    },
  ];
