...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title: "山脊如浪起伏，草色连着天穹。阳光掠过，一层青黛，一层梦。",
      image: "/image/甘肃/耳子屲梁.jpg",
    },
    {
      title:
        "天地只余黑与白，山在沉默中横陈，仿佛古老神灵的侧影。荒原无语，却比语言更辽远。",
      image: "/image/甘肃/黑独山.jpg",
    },
    {
      title:
        "云雾缭绕的山谷，如神秘的圣殿。石壁如经卷，草甸似祈祷，藏着人间最静的呼吸。",
      image: "/image/甘肃/扎尕那.jpg",
    },
  ];
