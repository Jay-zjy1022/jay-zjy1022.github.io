...
document.addEventListener("DOMContentLoaded", () => {
  const slides = [
    {
      title:
        "寒风凝结成霜，枝头挂满洁白的雾凇，在清晨的阳光中泛着晶莹的光，让这片寂静的世界多了一份生动与温情。",
      image: "/image/吉林/2.jpg",
    },
    {
      title:
        "白雪覆盖林海，寒光映照山巅，云雾翻腾如海浪；而当日出或夕阳洒落，整座山被染成金蓝交织的色彩，壮阔而静美。",
      image: "/image/吉林/7.jpg",
    },
    {
      title: "银装素裹，宛若冰雪仙境",
      image: "/image/吉林/8.jpg",
    },
    {
      title: "春赏山花，秋看五花",
      image: "/image/吉林/9.jpg",
    },
  ];
